...
<div class="container">
    ...
    <div>
        <a class="btn btn-default" href="{!! action('PageController@viewDisplay')!!}" style="width:150; height:40; background: #0d2945; margin-left:450px; font: bold; color: #edfdfd;">VIEW PROJECTS</a>
    </div>
</div>
</body>
